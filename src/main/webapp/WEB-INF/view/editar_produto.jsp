...
<head>
    ...
    <title>Lumi - Alterar Produto</title>
...
<div class="flex pt-16 sm:pt-20 min-h-screen">
    ...
    <main class="sm:ml-64 flex-1 sm:p-8">
        <h1
                ...
                data-aos="fade-down">Alterar Produto</h1>
        <div
            ...
            <form action="alterar-produto" method="post">
                ...
                <div id="etapa1" class="mb-6">
                    <label for="codigo-barras"
                        ...
                        de Barras:</label>
                    <input type="text" id="codigo-barras" name="codigo-barras" required readonly
                           class="w-full px-4 py-3 border border-gray-300 rounded-[15px] focus:ring-2 focus:ring-[#7F3FBF] focus:border-transparent mb-2"
                           placeholder="Digite o número do código de barras..." value="<%=request.getAttribute("codigo-barras")%>">
                    <label for="nome"
                           class="block text-gray-700 text-sm font-medium mb-2 mt-2">Nome:</label>
                    <input type="text" id="nome" name="nome" required
                           class="w-full px-4 py-3 border border-gray-300 rounded-[15px] focus:ring-2 focus:ring-[#7F3FBF] focus:border-transparent mb-2"
                           placeholder="Digite o nome do produto..." value="<%=request.getAttribute("nome")%>">
                    ...
                    <input type="text" id="fabricante" name="fabricante" required
                           class="w-full px-4 py-3 border border-gray-300 rounded-[15px] focus:ring-2 focus:ring-[#7F3FBF] focus:border-transparent mb-2"
                           placeholder="Digite o nome correspondente ao fabricante do produto..." value="<%=request.getAttribute("fabricante")%>">
                    <label for="industria"
                    ...
                    <select
                        ...
                        <option selected value="<%=request.getAttribute("nome-industria")%>"><%=request.getAttribute("nome-industria")%></option>
                    ...
                    <textarea id="descricao" name="descricao" required
                              ...
                              rows="2"
                              oninput="autoResizeTextarea(this)"><%=request.getAttribute("descricao")%></textarea>
                    <label for="massa"
                    ...
                    <input type="number" step="0.001" min="0" id="massa"
                           name="massa" required
                           class="w-full px-4 py-3 border border-gray-300 rounded-[15px] focus:ring-2 focus:ring-[#7F3FBF] focus:border-transparent"
                           placeholder="Ex: 1.807" value="<%=request.getAttribute("massa")%>">
