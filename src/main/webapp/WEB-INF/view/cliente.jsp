<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ page import="java.util.List" %>
        <%@ page import="com.example.lumi.Model.Cliente" %>
            <% @SuppressWarnings("unchecked") List<Cliente> clientes = (List<Cliente>)
                        ...
                        <header class="bg-[#7F3FBF] text-white fixed top-0 left-0 right-0 z-50 h-16 sm:h-20 shadow-md">
                            <div class="container mx-auto px-4 py-3 sm:py-4 h-full flex items-center justify-between">
                                <h1 class="sm:ml-[-5%]"><img
                                        src="${pageContext.request.contextPath}/assets/logo%20branca.png" width="80%"
                                ...
                                <div class="flex flex-col h-full">
                                    ...
                                    <div class="p-4 flex-grow overflow-y-auto">
                                        <ul class="space-y-2">
                                            ...
                                            <li><a href="site"
                                                    class="flex items-center p-3 rounded-lg hover:bg-gray-100 text-[cinza-escuro]"><i
                                                        data-feather="globe" class="mr-3"></i>Site</a></li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <table class="w-full hidden sm:table">
                                        <thead>
                                            <tr class="bg-[#3C9D9B] text-white">
                                                ...
                                                <th class="p-3 text-left">Endereço (UF, Cidade,
                                                    CEP)</th>
                                        ...
                                        <tbody>
                                            <% for (int i=0; i < clientes.size(); i++) { if (i % 2==0) { %>
                                                <tr class="bg-white">
                                                    ...
                                                    <td class="p-3 border-b">
                                                        <%=clientes.get(i).getNomeSobrenome()%>
                                                    </td>
                                                    <td class="p-3 border-b">
                                                        <%=clientes.get(i).getDataNascimento()%>
                                                    </td>
                                                    <td class="p-3 border-b">
                                                        <%=clientes.get(i).getPeso()%>
                                                    </td>
                                                    <td class="p-3 border-b">
                                                        <%=clientes.get(i).getAltura()%>
                                                    </td>
                                                    <td class="p-3 border-b">
                                                        <%=clientes.get(i).getTelefone()%>
                                                    </td>
                                                    <td class="p-3 border-b">
                                                        <%=clientes.get(i).getSenha()%>
                                                    </td>
                                                    <td class="p-3 border-b">
                                                        <%=clientes.get(i).getEnderecoCidade() + ", " +
                                                            clientes.get(i).getEnderecoUf() + ", " +
                                                            clientes.get(i).getEnderecoCep()%>
                                                    </td>
                                                    <td class="p-3 border-b text-right">
                                                        <div class="flex space-x-2 justify-end">
                                                            <a href="alteracao-cliente?idCliete=<%=clientes.get(i).getEmail()%>"
