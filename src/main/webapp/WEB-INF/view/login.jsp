...
<html lang="pt-BR">
    ...
    <body class="bg-gray-50 min-h-screen flex flex-col">
        <header>
            <h1><img src="${pageContext.request.contextPath}/assets/logo%20branca.png" width="80%" style="align-items: center;"></h1>
        </header>
            ...
            <div class="container mx-auto px-6">
                <div class="grid md:grid-cols-3 gap-8 items-center">
                    <div>
                        ...
                        <a href="${pageContext.request.contextPath}/index.html" class="site inline-block mt-5 text-center">Site</a>
                    </div>
                    ...
                    <div class="flex justify-center md:justify-end">
                        <img src="${pageContext.request.contextPath}/assets/Group%20191.png" alt="Logo Lumi" width="60%" style="margin-top: 5%;">
                    </div>
                </div>
            </div>
