    ...
    <%@ page import="com.example.lumi.Model.Industria" %>
        <%@ page import="com.example.lumi.Model.Plano" %>
            <%@ page import="java.util.List" %>
                <% @SuppressWarnings("unchecked") List<Plano> planos = (List<Plano>)
                        request.getAttribute("planos-lista");
                        %>
                        <!DOCTYPE html>
                        <html lang="pt-BR">
                            ...
                            <div class="flex pt-16 sm:pt-20 min-h-screen">
                                ...
                                <main class="sm:ml-64 flex-1 sm:p-8">
                                    ...
                                    <h1 class="text-[2.25rem] font-bold text-[#333333] mb-8 text-center mt-[2%]"
                                        data-aos="fade-down">Editar Indústria</h1>
                                            ...
                                            <div>
                                                ...
                                                <select name="plano" id="plano"
                                                    ...
                                                    <%for (int i=0; i < planos.size(); i++) {%>
                                                        <option value="<%=planos.get(i).getNome()%>">
                                                            <%=planos.get(i).getNome()%>
                                                        </option>
                                                        <%}%>
                                                </select>
                                            </div>
