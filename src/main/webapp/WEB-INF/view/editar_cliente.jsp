  ...
  <body class="bg-gray-50 min-h-screen">
    ...
    <div class="flex pt-16 sm:pt-20 min-h-screen">
        ...
        <div class="flex flex-col h-full">
          ...
          <div class="p-4 flex-grow overflow-y-auto">
            <ul class="space-y-2">
              ...
              <li><a href="industrias" class="flex items-center p-3 rounded-lg hover:bg-gray-100  text-[#333333]"><i
      ...
      <main class="sm:ml-64 flex-1 sm:p-8">
        ...
        <h1 class="text-[2.25rem] font-bold text-[#333333] mb-8 text-center mt-[3%]" data-aos="fade-down">Alterar
          Cliente
        </h1>
