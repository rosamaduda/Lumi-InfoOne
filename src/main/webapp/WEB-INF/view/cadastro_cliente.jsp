  ...
  <body class="bg-gray-50 min-h-screen">
    <header class="bg-[#7F3FBF] text-white fixed top-0 left-0 right-0 z-50 h-16 sm:h-20 shadow-md">
      <div class="container mx-auto px-4 py-3 sm:py-4 h-full flex items-center justify-between">
        <h1 class="sm:ml-[-5%]"><img src="${pageContext.request.contextPath}/assets/logo%20branca.png" width="80%"
    ...
    <div class="flex pt-16 sm:pt-20 min-h-screen">
      ...
      <nav id="sidebar"
        ...
        <div class="flex flex-col h-full">
          ...
          <div class="p-4 flex-grow overflow-y-auto">
            <ul class="space-y-2">
              <li><a href="portal" class="flex items-center p-3 rounded-lg hover:bg-gray-100 text-[#333333]"><i
                    data-feather="home" class="mr-3"></i>Portal
                  ADM</a></li>
              <li><a href="ingredientes" class="flex items-center p-3 rounded-lg hover:bg-gray-100  text-[#333333]"><i
                    data-feather="package" class="mr-3"></i>Ingredientes</a></li>
              <li><a href="alergias" class="flex items-center p-3 rounded-lg hover:bg-gray-100  text-[#333333]"><i
              ...
              <li><a href="industria" class="flex items-center p-3 rounded-lg hover:bg-gray-100  text-[#333333]"><i
                    data-feather="tool" class="mr-3"></i>Indústria</a></li>
              <li><a href="favoritos" class="flex items-center p-3 rounded-lg hover:bg-gray-100  text-[#333333] "><i
                    data-feather="heart" class="mr-3"></i>Favoritos</a></li>
              <li><a href="avaliacoes" class="flex items-center p-3 rounded-lg hover:bg-gray-100 text-[#333333] "><i
                    data-feather="star" class="mr-3"></i>Avaliações</a></li>
              <li><a href="${pageContext.request.contextPath}/index.html"
                  class="flex items-center p-3 rounded-lg hover:bg-gray-100 text-red-500"><i data-feather="log-out"
      ...
      <main class="sm:ml-64 flex-1 sm:p-8">
        ...
        <h1 class="text-[2.25rem] font-bold text-[#333333] mb-8 text-center mt-[3%]" data-aos="fade-down">Adicionar
          Cliente</h1>
        <div id="input" class="bg-white rounded-[15px] shadow-md p-8 max-w-lg mx-auto mt-[3%]" data-aos="fade-up"
          data-aos-delay="100">
          <form action="adicionar-cliente" method="post">
            <div class="mb-6">
              ...
              <label for="sobrenome" class="block text-gray-700 text-sm font-medium mb-2 mt-2">Sobrenome:</label>
              <input type="text" id="sobrenome" name="sobrenome"
                class="w-full px-4 py-3 border border-gray-300 rounded-[15px] focus:ring-2 focus:ring-[#7F3FBF] focus:border-transparent"
                placeholder="Digite o sobrenome do cliente...">

              <label for="peso" class="block text-gray-700 text-sm font-medium mb-2 mt-2">Peso
                (kg):</label>
              <input type="number" step="0.01" min="0" id="peso" name="peso"
                class="w-full px-4 py-3 border border-gray-300 rounded-[15px] focus:ring-2 focus:ring-[#7F3FBF] focus:border-transparent"
                placeholder="Ex: 76">

              <label for="altura" class="block text-gray-700 text-sm font-medium mb-2 mt-2">Altura
                (m):</label>
              <input type="number" step="0.01" min="0" id="altura" name="altura"
                class="w-full px-4 py-3 border border-gray-300 rounded-[15px] focus:ring-2 focus:ring-[#7F3FBF] focus:border-transparent"
                placeholder="Ex: 1,90">

              <label for="diabetes" class="block text-gray-700 text-sm font-medium mb-2 mt-2">Tipo de diabetes:</label>
              ...
              <label for="data" class="block text-gray-700 text-sm font-medium mb-2 mt-2">Data
                de nascimento:</label>
              ...
              <label for="cidade" class="block text-gray-700 text-sm font-medium mb-2 mt-2">Cidade:</label>
              <input type="text" id="cidade" name="cidade"
                class="w-full px-4 py-3 border border-gray-300 rounded-[15px] focus:ring-2 focus:ring-[#7F3FBF] focus:border-transparent"
                placeholder="Ex: Águas de Lindóia">

              <label for="estado" class="block text-gray-700 text-sm font-medium mb-2 mt-2">Estado:</label>
              ...
              <label for="cep" class="block text-gray-700 text-sm font-medium mb-2 mt-2">CEP:</label>
