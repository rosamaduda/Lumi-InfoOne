...
<html lang="pt-BR">
    <head>
        ...
        <title>Lumi - Adicionar Favorito</title>
        <link rel="icon"
                ...
                <div id="input"
                    ...
                    <form action="adicionar-favorito" method="post">
                        <div class="mb-6">
                            ...
                            <label for="e-mail"
                                class="block text-gray-700 text-sm font-medium mb-2 mt-2">Email
                                do Cliente:</label>
                            ...
                            <div class="text-center">
                                <button
                                    class="bg-[#C6F500] text-gray-800 font-bold py-3 px-6 rounded-[15px] hover:bg-lemon-500 transition-colors mt-[3%]">
                                    Adicionar
                                </button>
                            </div>
                        </form>
