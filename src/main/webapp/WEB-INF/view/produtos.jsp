                        ...
                        <div
                            ...
                            <div class="relative" id="dropdown">
                                <button id="filtro-botao"
                                    ...
                                    <span id="filtro-texto">Nome</span>
                                    <i class="ml-2 text-white w-4 h-4"
                                        data-feather="chevron-down"></i>
                                </button>
                                <!-- Menu -->
                                <div id="menu"
                                    class="absolute hidden mt-2 bg-white rounded-lg shadow-lg w-max z-10">
                                    <button
                                        class="block text-gray-700 text-sm px-4 py-2 rounded-lg w-full text-left hover:bg-gray-100"
                                        data-value="nome">Nome</button>
                                    <button
                                        class="block text-gray-700 text-sm px-4 py-2 rounded-lg w-full text-left hover:bg-gray-100"
                                        data-value="fabricante">Fabricante</button>
                                    <button
                                        class="block text-gray-700 text-sm px-4 py-2 rounded-lg w-full text-left hover:bg-gray-100"
                                        data-value="massa">Massa</button>
                                    <button
                                        class="block text-gray-700 text-sm px-4 py-2 rounded-lg w-full text-left hover:bg-gray-100"
                                        data-value="indústria">Indústria</button>
                                </div>
                            </div>
                            ...
                            <button type="submit" class="ml-2">
                                <i
                                    class="text-gray-500 hover:text-[#3C9D9B] cursor-pointer text-2xl"
                    ...
                    <table
                        ...
                        <tbody>
                            <tr class="bg-white">
                                ...
                                <td class="p-3 border-b"></td>
                                <td
                                    class="p-3 border-b max-w-[20%] whitespace-normal break-words align-top"></td>
                                <td class="p-3 border-b"></td>
                                <td class="p-3 border-b"></td>
                                <td class="p-3 border-b text-right">
                                    <div class="flex space-x-2 justify-end">
                                        ...
                                        <a onclick="mostrarRedirecionando()"
                                            href="alteracao-produto?idProduto=<%= produtos.get(i).getId() %>"
