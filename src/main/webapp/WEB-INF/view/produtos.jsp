...
<%@ page import="com.example.lumi.Model.Produto" %>
<%@ page import="java.util.List" %>
<%@ page import="com.example.lumi.Model.Industria" %>
<%@ page import="com.example.lumi.Model.InformacaoNutricional" %>
<%
    @SuppressWarnings("unchecked")
    List <Produto> listaProdutos = (List<Produto>) request.getAttribute("produtos-lista");
    @SuppressWarnings("unchecked")
    List <Industria> listaIndustrias = (List<Industria>) request.getAttribute("nomeIndustria-lista");
    @SuppressWarnings("unchecked")
...
<div class="flex pt-16 sm:pt-20 min-h-screen">
    ...
    <nav id="sidebar" class="fixed left-0 top-16 sm:top-20 h-full w-64 bg-white shadow-lg z-40 transform -translate-x-full sm:translate-x-0 transition-transform duration-300">
            ...
            <div class="p-4 flex-grow overflow-y-auto">
                <ul class="space-y-2">
                    ...
                    <li><a href="avaliacoes"
                            class="flex items-center p-3 rounded-lg hover:bg-gray-100 text-[#333333] "><i
                            data-feather="star" onclick="mostrarRedirecionando()"
    ...
    <main class="flex-1 p-4 sm:p-8 sm:ml-64 h-full flex flex-col overflow-hidden">
        ...
        <!-- Busca com filtros -->
        <form action="filtro-produto" method="get" class="mb-6 relative z-10" data-aos="fade-up">
            <div class="flex items-center bg-white rounded-full shadow-lg px-5 py-3 w-full">
                ...
                <div class="relative" id="dropdown">
                    ...
                    <div id="menu" class="absolute hidden mt-2 bg-white rounded-lg shadow-lg w-max z-50">
                        ...
                        <button type="button" data-value="Fabricante" class="block text-gray-700 text-sm px-4 py-2 w-full text-left hover:bg-gray-100">Fabricante</button>
                        <button type="button" data-value="Massa" class="block text-gray-700 text-sm px-4 py-2 w-full text-left hover:bg-gray-100">Massa</button>
                        <button type="button" data-value="Indústria" class="block text-gray-700 text-sm px-4 py-2 w-full text-left hover:bg-gray-100">Indústria</button>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-x-auto overflow-y-auto w-full flex-1 max-h-full"
            ...
            <table class="hidden sm:table table-auto text-left align-top min-w-full">
                ...
                <tr class="bg-[#3C9D9B] text-white">
                    ...
                    <th class="p-3 text-left">Informação <br>
                        Nutricional</th>
                ...
                <div
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-sm text-[#333333]">
                                    <span
                                            class="font-bold text-gray-700">Código
                                        de Barras:</span>
                            <span class="font text-gray-800">
                                        <%=
                                        listaProdutos.get(i).getCodigoBarras() %>
                                    </span>
                        </p>
                        <p class="text-sm text-[#333333]">
                                    <span
                        ...
                        <p class="text-sm text-[#333333]">
                                    <span
                                            class="font-bold text-gray-700">Fabricante:</span>
                            <span class="font text-gray-800">
                                        <%=
                                        listaProdutos.get(i).getFabricante()
                                        %>
                                    </span>
                        </p>
                        <p
                        ...
                        <p class="text-sm text-[#333333]">
                                    <span
                                            class="font-bold text-gray-700">Massa:</span>
                            <span class="font text-gray-800">
                                        <%=
                                        listaProdutos.get(i).getMassa() + "kg"
                                        %>
                                    </span>
                        </p>
                        <p class="text-sm text-[#333333]">
...
<script
        src="${pageContext.request.contextPath}/js/carregandoRemover.js"></script>
