    ...
    <main class="flex-1 p-4 sm:p-8 sm:ml-64">
        ...
        <div class="bg-white rounded-lg shadow overflow-x-auto overflow-y-auto w-full flex-1 max-h-full"
            ...
            <div
                ...
                <div
                    ...
                    <a onclick="mostrarRedirecionando()" href="cadastro-produto"
        ...
        <div id="tela-redirecionamento"
            ...
            <div
                ...
                <h1
                    class="text-2xl font-medium mt-8 text-gray-700">Redirecionando...</h1>
        ...
        <div id="popupConfirmacao"
            ...
            <div
                class="bg-white rounded-2xl shadow-xl p-6 w-90 text-center animate-fadeIn">
                <div
                    class="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i data-feather="alert-triangle"
                        class="w-8 h-8 text-red-500"></i>
                </div>
                <h2
                    class="text-xl font-semibold text-gray-800 mb-2">Remover?</h2>
                <p
                    class="text-gray-600 mb-6 leading-relaxed w-[100%] text-center">
